...
const SOURCES: Source[] = [
  { id: "vidking",     label: "VidKing",     url: (id) => `https://www.vidking.net/embed/movie/${id}?color=9146ff&autoPlay=true` },
  { id: "vidking-alt", label: "VidKing Alt", url: (id) => `https://vidking.net/embed/movie/${id}?color=9146ff` },
];
