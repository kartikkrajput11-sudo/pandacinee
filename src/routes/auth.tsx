      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-6 pb-12">
        <div className="w-full max-w-sm animate-fade-up">
          ...
          <button
            ...
            disabled={loading}
            className="w-full mb-5 py-3 bg-candle text-velvet rounded-full font-medium text-sm hover:brightness-95 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
            <svg width="18" height="18" viewBox="0 0 24 24">
              ...
              <path
                fill="#EA4335"
                d="M12 4.75c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 1.47 14.97.5 12 .5A10.99 10.99 0 0 0 2.18 7.07l3.66 2.84C6.71 7.31 9.14 5.38 12 4.75z"
              />
            </svg>
